...
:root {
  ...
  /* tone 家族＝與 GUI v3 同一組（src/static/css/v2/tokens.css 亮色）。
     2026-09-09 之前這裡還是 v2 留下的那組——不是為紙張調過的選擇，只是
     移植時沒有一起搬。同一份資料在 GUI 與 PDF 裡不該有兩種綠。 */
  --tone-ok-border: #166644;
  --tone-warn-border: #FFA22F;
  --tone-crit-border: #BE122F;
  --tone-info-border: #2D454C;
  --tone-neutral-border: #9AA3A6;
  ...
  --tone-info-fg: #2D454C;
  --tone-info-bg: #E5F2F9;
  --tone-neutral-fg: #5B6164;
  --tone-neutral-bg: #F1F0EC;
}
