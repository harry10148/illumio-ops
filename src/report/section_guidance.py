...
REGISTRY: dict[str, SectionGuidance] = {
    ...
    "ven_fleet_pipeline": SectionGuidance(
        module_id="ven_fleet_pipeline",
        purpose_key="rpt_guidance_ven_fleet_pipeline_purpose",
        watch_signals_key="rpt_guidance_ven_fleet_pipeline_signals",
        how_to_read_key="rpt_guidance_ven_fleet_pipeline_how",
        recommended_actions_key="rpt_guidance_ven_fleet_pipeline_actions",
        primary_audience="mixed",
        profile_visibility=("security_risk", "network_inventory"),
        min_detail_level="full",
    ),
    "ven_fleet_compat": SectionGuidance(
        module_id="ven_fleet_compat",
        purpose_key="rpt_guidance_ven_fleet_compat_purpose",
        watch_signals_key="rpt_guidance_ven_fleet_compat_signals",
        how_to_read_key="rpt_guidance_ven_fleet_compat_how",
        recommended_actions_key="rpt_guidance_ven_fleet_compat_actions",
        primary_audience="mixed",
        profile_visibility=("security_risk", "network_inventory"),
        min_detail_level="full",
    ),
    "ven_fleet_score": SectionGuidance(
        module_id="ven_fleet_score",
        purpose_key="rpt_guidance_ven_fleet_score_purpose",
        watch_signals_key="rpt_guidance_ven_fleet_score_signals",
        how_to_read_key="rpt_guidance_ven_fleet_score_how",
        recommended_actions_key="rpt_guidance_ven_fleet_score_actions",
        primary_audience="mixed",
        profile_visibility=("security_risk", "network_inventory"),
        min_detail_level="full",
    ),
    "ven_fleet_gaps": SectionGuidance(
        module_id="ven_fleet_gaps",
        purpose_key="rpt_guidance_ven_fleet_gaps_purpose",
        watch_signals_key="rpt_guidance_ven_fleet_gaps_signals",
        how_to_read_key="rpt_guidance_ven_fleet_gaps_how",
        recommended_actions_key="rpt_guidance_ven_fleet_gaps_actions",
        primary_audience="mixed",
        profile_visibility=("security_risk", "network_inventory"),
        min_detail_level="full",
    ),
