...
//
// PORT OF design/v2/mockup/js/components/chart.mjs — byte-identical. It has
// no i18n keys to rename (no t()/tf() calls anywhere in this file) and
// already returns {el, destroy()} from rankedBars(), so it already satisfies
// this task's teardown contract without any change.
