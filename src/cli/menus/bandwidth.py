...
def add_bandwidth_volume_menu(cm: ConfigManager, edit_rule=None) -> None:
    ...
    _wizard_step(1, 5, t('wiz_basic_setup'), path=f"{t('cli_area_policy')} > {t('wiz_add_bandwidth_rule')}")
    print("")
    ...
    _wizard_step(2, 5, t('wiz_select_metric'), path=f"{t('cli_area_policy')} > {t('wiz_add_bandwidth_rule')}")
    ...
    _wizard_step(3, 5, t('wiz_filters'), path=f"{t('cli_area_policy')} > {t('wiz_add_bandwidth_rule')}")
    ...
    _wizard_step(4, 5, t('wiz_threshold'), path=f"{t('cli_area_policy')} > {t('wiz_add_bandwidth_rule')}")
    ...
    _wizard_step(5, 5, t('wiz_review_save'), path=f"{t('cli_area_policy')} > {t('wiz_add_bandwidth_rule')}")
    summary = [
        f"{t('sum_type')}: {rtype}",
        f"{t('sum_name')}: {name}",
