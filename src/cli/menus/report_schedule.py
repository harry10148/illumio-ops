...
def _add_report_schedule_wizard(cm: ConfigManager, edit_sched: dict = None) -> None:
    ...
    # Step 1: Name
    _wizard_step(1, 7, t('sched_name'), path=f"{t('cli_area_policy')} > {t('wiz_report_schedule')}")
    ...
    # Step 2: Report type
    _wizard_step(2, 7, t('sched_report_type'), path=f"{t('cli_area_policy')} > {t('wiz_report_schedule')}")
    ...
    # Step 3: Frequency
    _wizard_step(3, 7, t('sched_schedule_type'), path=f"{t('cli_area_policy')} > {t('wiz_report_schedule')}")
    ...
    _wizard_step(4, 7, t('wiz_execution_time', tz=tz_label), path=f"{t('cli_area_policy')} > {t('wiz_report_schedule')}")
    ...
    _wizard_step(5, 7, t('sched_lookback_days'), path=f"{t('cli_area_policy')} > {t('wiz_report_schedule')}")
    ...
    _wizard_step(6, 7, t('sched_format'), path=f"{t('cli_area_policy')} > {t('wiz_report_schedule')}")
    ...
    # Step 7: Email
    _wizard_step(7, 7, t('wiz_email_options'), path=f"{t('cli_area_policy')} > {t('wiz_report_schedule')}")
