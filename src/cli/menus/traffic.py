...
def add_traffic_menu(cm: ConfigManager, edit_rule=None) -> None:
    ...
    _wizard_step(1, 5, t('wiz_basic_setup'), path=f"{t('cli_area_policy')} > {t('wiz_add_traffic_rule')}")
    print("")
    ...
    _wizard_step(3, 5, t('wiz_trigger_threshold'), path=f"{t('cli_area_policy')} > {t('wiz_add_traffic_rule')}")
    ...
    _wizard_step(4, 5, t('wiz_exclusions'), path=f"{t('cli_area_policy')} > {t('wiz_add_traffic_rule')}")
    ...
    _wizard_step(5, 5, t('wiz_review_save'), path=f"{t('cli_area_policy')} > {t('wiz_add_traffic_rule')}")
    pd_text = {
