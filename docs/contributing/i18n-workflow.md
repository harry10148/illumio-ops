...
Cross-reference: [`../architecture/i18n-contract.md`](../architecture/i18n-contract.md)
...
- [i18n Contract (architecture)](../architecture/i18n-contract.md) — the underlying contract
