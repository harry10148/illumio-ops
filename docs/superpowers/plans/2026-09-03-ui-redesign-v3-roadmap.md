...
| 3D | `2026-09-07-phase3d-final.md` | spec §7：主場景六步 Playwright 真機走查＋截圖、五區 coverage（**現況已 108/108，任務是維持**）、docs（gui-tour 依五區重寫＋路由守門）、CHANGELOG＋版本號 **5.1.0**（使用者 2026-09-07 裁決；我建議 6.0.0）、release tag、測試機殘檔處置 | 3A–3C（全數已交付） | **已交付 2026-09-07**：`51018e56`（主場景走查＋告警頁型別修復）／`58230a79`／`3de83b7d`（gui-tour 五區＋路由守門）／`6252862e`（CHANGELOG＋5.1.0）；tag **v5.1.0**；驗收報告 `tmp/phase3d-verification/report.md` |
